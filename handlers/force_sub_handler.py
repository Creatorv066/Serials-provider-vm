    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned to use me. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/Marathi_Tv_Serials_Bot).",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Something went Wrong. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/Marathi_Tv_Serials_Bot).",
            disable_web_page_preview=True
        )
        return 200
    return 200
